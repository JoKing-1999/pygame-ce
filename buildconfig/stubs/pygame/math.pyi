...
class Matrix4x4:
    ...
    @classmethod
    def diagonal(cls, x: float, y: float, z: float, w: float) -> Matrix4x4: ...
    @classmethod
    def from_rows(
        cls,
        row0: SequenceLike[float],
        row1: SequenceLike[float],
        row2: SequenceLike[float],
        row3: SequenceLike[float],
    ) -> Matrix4x4: ...
    @classmethod
    def from_columns(
        cls,
        column0: SequenceLike[float],
        column1: SequenceLike[float],
        column2: SequenceLike[float],
        column3: SequenceLike[float],
    ) -> Matrix4x4: ...
    @classmethod
    def translation(cls, offset: Vector3 | SequenceLike[float], /) -> Matrix4x4: ...
    @classmethod
    def rotation_axis_angle(
        cls, axis: Vector3 | SequenceLike[float], angle: float
    ) -> Matrix4x4: ...
    @overload
    @classmethod
    def scaling(cls, factor: float, /) -> Matrix4x4: ...
    @overload
    @classmethod
    def scaling(cls, factor: Vector3 | SequenceLike[float], /) -> Matrix4x4: ...
    @classmethod
    def look_at(
        cls,
        eye: Vector3 | SequenceLike[float],
        target: Vector3 | SequenceLike[float],
        up: Vector3 | SequenceLike[float],
    ) -> Matrix4x4: ...
    @classmethod
    def perspective(
    ...
    def __len__(self) -> int: ...
    def __iter__(self) -> Iterator[Vector4]: ...
    ...
    def is_affine(self, tolerance: float = ...) -> bool: ...
    ...
    def __truediv__(self, scalar: float) -> Matrix4x4: ...
    @overload
    def __matmul__(self, other: Matrix4x4) -> Matrix4x4: ...
    @overload
    def __matmul__(self, other: Vector4) -> Vector4: ...
    @overload
    def __matmul__(self, other: Vector3) -> Vector3: ...
    def transform_point(self, point: Vector3 | SequenceLike[float], /) -> Vector3: ...
    def transform_direction(
        self, direction: Vector3 | SequenceLike[float], /
    ) -> Vector3: ...
    def translate(self, offset: Vector3 | SequenceLike[float], /) -> Matrix4x4: ...
    def translate_ip(self, offset: Vector3 | SequenceLike[float], /) -> None: ...
    def rotate(
        self, axis: Vector3 | SequenceLike[float], angle: float
    ) -> Matrix4x4: ...
    def rotate_ip(self, axis: Vector3 | SequenceLike[float], angle: float) -> None: ...
    def scale(self, factor: float | Vector3 | SequenceLike[float], /) -> Matrix4x4: ...
    def scale_ip(self, factor: float | Vector3 | SequenceLike[float], /) -> None: ...
    def transpose(self) -> Matrix4x4: ...
    def transpose_ip(self) -> None: ...
    def invert(self) -> Matrix4x4: ...
    def invert_ip(self) -> None: ...
    ...
    def equals(self, other: Matrix4x4, tolerance: float = ...) -> bool: ...
