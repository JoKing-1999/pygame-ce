...
class RenderPass:
    def __init__(self, clear_color: ColorLike = None, load_op: int = 0, store_op: int = 0): ...
    def begin(self, window: Window | None = None, texture: Texture | None = None, layer: int = 0, cycle: bool = False, resolve_texture: Texture | None = None, depth_stencil_texture: Texture | None = None, depth_clear: float = 0, depth_store_op: int = GPU_STOREOP_DONT_CARE, stencil_store_op: int = GPU_STOREOP_DONT_CARE, clear_stencil: int = 0, depth_cycle: bool = True) -> None: ...
    def end(self) -> None: ...
...
class Texture:
    ...
    def upload(self, data: Surface | bytes | bytearray, layer: int = 0, mip_level: int = 0) -> None: ...
...
class Sampler:
    def __init__(self, filter: int, mipmap_mode: int, address_mode: int, anisotropy: float = 0, min_lod: float = 0.0, max_lod: float = 0.0, mip_lod_bias: float = 0.0): ...
...
GPU_TEXTUREFORMAT_B8G8R8A8_UNORM_SRGB: int
GPU_TEXTUREFORMAT_R8G8B8A8_UNORM_SRGB: int
