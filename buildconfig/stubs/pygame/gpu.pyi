...
def blit_texture(source: Texture, source_w: int, source_h: int, dest: Texture, dest_w: int, dest_h: int, source_layer: int = 0, source_x: int = 0, source_y: int = 0, dest_layer: int = 0, dest_x: int = 0, dest_y: int = 0, load_op: int = ..., filter: int = ...) -> None: ...
