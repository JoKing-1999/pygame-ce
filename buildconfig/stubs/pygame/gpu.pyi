...
class CopyPass:
    ...
    def begin(self) -> None: ...
    def end(self) -> None: ...
    def upload_to_texture(self, texture: Texture, data: Surface | bytes | bytearray, cycle: bool = False) -> None: ...
    def upload_to_buffer(self, buffer: Buffer, data: SupportsBuffer, cycle: bool = False) -> None: ...
    def download_from_texture(self, texture: Texture) -> bytes: ...
    def download_from_buffer(self, buffer: Buffer, size: int) -> bytes: ...
