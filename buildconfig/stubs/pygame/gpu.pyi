...
def blit_texture(source: Texture, source_w: int, source_h: int, dest: Texture, dest_w: int, dest_h: int, source_layer: int = 0, source_x: int = 0, source_y: int = 0, dest_layer: int = 0, dest_x: int = 0, dest_y: int = 0, load_op: int = ..., filter: int = ..., flip_mode: int = ..., source_mip_level: int = 0, dest_mip_level: int = 0) -> None: ...
...
class RenderPass:
    ...
    def begin(self, window: Window | None = None, texture: Texture | None = None, layer: int = 0, cycle: bool = False, resolve_texture: Texture | None = None, depth_stencil_texture: Texture | None = None) -> None: ...
    def end(self) -> None: ...
